package com.qiaoyanan.springbootplus.generator;

import com.google.common.base.CaseFormat;

import com.qiaoyanan.springbootplus.core.constant.ProjectConstant;
...
/**
 *  本项目(springbootplus)主要是用来生成controller,service,(service)imp,
 *  mapper,mapper.xml,model(实体类)，主要用来生成单表的增删改查和列表查询等功能,
 *  此项目在<https://github.com/MyBeany/mySpringBoot>的基础上，把原项目的bug进行了
 *  修改，并结合自己在最近的工作中进行了封装。
 * @author qiaoyn
 * 2019/12/05 16:25
 **/
public class CodeGenerator {
        ...
        // JDBC配置，请修改为你项目的实际配置
        private static final String JDBC_URL = "jdbc:mysql://localhost:3306/guns?serverTimezone=UTC";
        ...
        // @author
        private static final String AUTHOR = "乔亚南";
